...
/// wrong guess gives the starting letter. Image-based modes already show a picture, so
/// the hint stays light — just the region. A wrong guess then earns a stronger clue that
